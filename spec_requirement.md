...
* **처리 로직:**
    ...
    3.  [cite_start]허용 문자 검증 (**기본: A/C/G/T/N**) [cite: 286]
* **우선순위:** **MUST**
* **예외 처리:**
...
* **우선순위:** **MUST**
* [cite_start]**수용 기준:** 10,000bp 데이터 로드 시 스크롤/줌 동작 중 **60fps 유지**. [cite: 309]

### FR-003: 뷰 컬링(View Culling) 최적화
* [cite_start]**설명:** 현재 뷰포트(화면) 밖의 데이터는 렌더링 연산에서 제외한다. [cite: 311]
* **처리 로직:**
    1.  [cite_start]UI의 **1-based 좌표**를 내부 연산용 **0-based 인덱스**로 변환 (`Index = Coordinate - 1`) [cite: 314]
...
* [cite_start]**설명:** 겹치는 프라이머 구간을 자동으로 Y축(높이)을 달리하여 배치한다. [cite: 339]
...
## 3.2 비기능 요구사항 (NFR)
* [cite_start]**성능:** 10,000bp 데이터 기준 렌더링 속도 60fps 유지. [cite: 364]
